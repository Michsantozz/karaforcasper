...
function ToolFallbackTrigger({
  ...
  const prefix = isCancelled ? "cancelled" : kind;
  ...
  return (
    ...
    >
      ...
      {!isCancelled && (
        <span
          aria-hidden
          data-slot="tool-fallback-trigger-kind-dot"
          className={cn(
      ...
      <span
        ...
        className={cn(
          "aui-tool-fallback-trigger-label-wrapper relative inline-block text-start font-mono text-xs leading-none",
      ...
      >
        ...
        {isRunning && (
          <span
            ...
            className="aui-tool-fallback-trigger-shimmer shimmer pointer-events-none absolute inset-0 font-mono text-xs motion-reduce:animate-none"
          >
            <span className="uppercase tracking-wider">{prefix}</span> /{" "}
            <b>{toolName}</b>
          </span>
        )}
      </span>
...
function ToolFallbackArgs({
  ...
  return (
    <div
      ...
      {...props}
    >
      <pre className="aui-tool-fallback-args-value bg-muted/40 text-foreground/90 rounded-[5px] border p-2.5 font-mono text-xs whitespace-pre-wrap">
        {argsText}
      </pre>
    </div>
  );
...
function ToolFallbackResult({
  ...
  return (
    <div
      ...
      {...props}
    >
      <p className="aui-tool-fallback-result-header text-muted-foreground font-mono text-[10px] uppercase tracking-wider">
        result
      </p>
      <pre className="aui-tool-fallback-result-content bg-muted/40 text-foreground/90 mt-1 rounded-[5px] border p-2.5 font-mono text-xs whitespace-pre-wrap">
